...
KC_390 =
{
    ...
    shape_table_data =
    {
        {
            file        = "KC-390",
            life        = 20,                -- resistencia (barra de vida)
            vis         = 3,
            desrt       = "KC-390_destr",
            fire        = { 300, 2 },
            username    = "KC-390",
    ...
    Damage = verbose_to_dmg_properties({
        ["NOSE_CENTER"]         = { args = { 140 }, critical_damage = 20, deps_cells = { "NOSE_LEFT_SIDE", "NOSE_RIGHT_SIDE" }, droppable = true, droppable_shape = "KC-390_NoseCone" },
        ["NOSE_LEFT_SIDE"]      = { args = { 141 }, critical_damage = 10 },
        ["NOSE_RIGHT_SIDE"]     = { args = { 142 }, critical_damage = 10 },
        ["COCKPIT"]             = { args = { 143 }, critical_damage = 20 },
        ["CABIN_LEFT_SIDE"]     = { args = { 144 }, critical_damage = 10 },
        ["CABIN_RIGHT_SIDE"]    = { args = { 145 }, critical_damage = 10 },
        ["CABIN_BOTTOM"]        = { args = { 146 }, critical_damage = 10 },
        ["FRONT_GEAR_BOX"]      = { args = { 147 }, critical_damage = 3, deps_cells = { "WHEEL_F" } },
        ["FUSELAGE_LEFT_SIDE"]  = { args = { 148 }, critical_damage = 20 },
        ["FUSELAGE_RIGHT_SIDE"] = { args = { 149 }, critical_damage = 20 },
        ["ENGINE_L"]            = { args = { 150 }, critical_damage = 3 },
        ["ENGINE_R"]            = { args = { 151 }, critical_damage = 3 },
        ["LEFT_GEAR_BOX"]       = { args = { 152 }, critical_damage = 3, deps_cells = { "WHEEL_L" } },
        ["RIGHT_GEAR_BOX"]      = { args = { 153 }, critical_damage = 3, deps_cells = { "WHEEL_R" } },
        ["WING_L_OUT"]          = { args = { 154 }, critical_damage = 8, deps_cells = { "AILERON_L" } },
        ["WING_R_OUT"]          = { args = { 155 }, critical_damage = 8, deps_cells = { "AILERON_R" } },
        ["AILERON_L"]           = { args = { 156 }, critical_damage = 3 },
        ["AILERON_R"]           = { args = { 157 }, critical_damage = 3 },
        ["WING_L_CENTER"]       = { args = { 158 }, critical_damage = 20, deps_cells = { "WING_L_OUT", "FLAP_L_OUT" } },
        ["WING_R_CENTER"]       = { args = { 159 }, critical_damage = 20, deps_cells = { "WING_R_OUT", "FLAP_R_OUT" } },
        ["FLAP_L_OUT"]          = { args = { 160 }, critical_damage = 4 },
        ["FLAP_R_OUT"]          = { args = { 161 }, critical_damage = 4 },
        ["WING_L_IN"]           = { args = { 162 }, critical_damage = 25, deps_cells = { "WING_L_CENTER", "FLAP_L_IN", "ENGINE_L" }, droppable = true, droppable_shape = "KC-390_WingLeft" },
        ["WING_R_IN"]           = { args = { 163 }, critical_damage = 25, deps_cells = { "WING_R_CENTER", "FLAP_R_IN", "ENGINE_R" }, droppable = true, droppable_shape = "KC-390_WingRight" },
        ["FLAP_L_IN"]           = { args = { 164 }, critical_damage = 3 },
        ["FLAP_R_IN"]           = { args = { 165 }, critical_damage = 3 },
        ["STABILIZER_L_OUT"]    = { args = { 166 }, critical_damage = 25, deps_cells = { "ELEVATOR_L" } },
        ["STABILIZER_R_OUT"]    = { args = { 167 }, critical_damage = 25, deps_cells = { "ELEVATOR_R" } },
        ["ELEVATOR_L"]          = { args = { 168 }, critical_damage = 5 },
        ["ELEVATOR_R"]          = { args = { 169 }, critical_damage = 5 },
        ["RUDDER"]              = { args = { 170 }, critical_damage = 5 },
        ["TAIL"]                = { args = { 171 }, critical_damage = 20, deps_cells = { "TAIL_LEFT_SIDE", "TAIL_RIGHT_SIDE", "TAIL_BOTTOM", "TAIL_TOP" } },
        ["TAIL_LEFT_SIDE"]      = { args = { 172 }, critical_damage = 5 },
        ["TAIL_RIGHT_SIDE"]     = { args = { 173 }, critical_damage = 5 },
        ["TAIL_BOTTOM"]         = { args = { 174 }, critical_damage = 5, droppable = true, droppable_shape = "KC-390_CargoDoor" },
        ["FUSELAGE_BOTTOM"]     = { args = { 175 }, critical_damage = 20 },
        ["WHEEL_F"]             = { args = { 176 }, critical_damage = 3 },
        ["WHEEL_L"]             = { args = { 177 }, critical_damage = 3 },
        ["WHEEL_R"]             = { args = { 178 }, critical_damage = 3 },
        ["TAIL_TOP"]            = { args = { 179 }, critical_damage = 25, deps_cells = { "STABILIZER_L_OUT", "STABILIZER_R_OUT", "RUDDER" } },
    }),

    DamageParts =
    {
        [1000 + 0]  = "KC-390_NoseCone",
        [1000 + 35] = "KC-390_WingLeft",
        [1000 + 36] = "KC-390_WingRight",
        [1000 + 58] = "KC-390_CargoDoor",
    },
